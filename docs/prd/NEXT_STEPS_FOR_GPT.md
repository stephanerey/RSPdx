...
- Define the target deliverable or operational outcome.
- Define what is explicitly in scope for the first delivery.
- Define what is explicitly out of scope.
- Review pack selection manually; no strong automatic recommendation was inferred.

## Recommended pack candidates
- none automatically suggested
